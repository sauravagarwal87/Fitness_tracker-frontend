...
import { getScheduledDietsService } from '../services/ScheduledDietService';
import { Link, useHistory } from 'react-router-dom';
import { withRouter } from 'react-router-dom';
//import Moment from 'moment';


const ViewAllScheduledDiet = () => {

  
   
    const [Sdact, setSdact] = useState(new ScheduledDiet());
...
export default ViewAllScheduledDiet;